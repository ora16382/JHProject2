package com.myspring.WebPro.Pboard.controller;
...
import com.myspring.WebPro.Pboard.service.BoardService;
...
@Controller("pboardController")
public class BoardControllerImpl implements BoardController{
	private static Logger logger = LoggerFactory.getLogger(BoardControllerImpl.class);
	private static final String ARTICLE_IMAGE_REPO = "C:\\board\\article_image\\politics";
	
	@Autowired
	BoardService pboardService;
	
	@Autowired
	ArticleVO particleVO;
	
	@Override
	@RequestMapping(value="/pboard/listArticles.do",method= {RequestMethod.GET, RequestMethod.POST})
	public ModelAndView listArticles(@RequestParam(value = "section", required = false) String _section, @RequestParam(value = "pageNum", required = false) String _pageNum,HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		Map articlesMap = pboardService.listArticles(page);
	...
	@Override
	@RequestMapping(value="/pboard/addNewArticle.do", method=RequestMethod.POST)
	@ResponseBody
	public ResponseEntity addNewArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse response) throws Exception{
		...
		if(memberVO == null) return new ResponseEntity("<script>location.href='"+multipartRequest.getContextPath()+"/pboard/listArticles.do';</script>",responseHeaders,HttpStatus.BAD_REQUEST);
		...
		try {
		int articleNO = pboardService.addNewArticle(articleMap);
		...
		message = "<script>"
				+ "location.href='"+multipartRequest.getContextPath()+"/pboard/listArticles.do';"
						+ "</script>";
		resEnt = new ResponseEntity(message,responseHeaders,HttpStatus.CREATED);
			...
			message = "<script>"
					...
					+ "location.href='"+multipartRequest.getContextPath()+"/pboard/articleForm.do';"
							+ "</script>";
	...
	@RequestMapping(value="/pboard/viewArticle.do", method=RequestMethod.GET)
	public ModelAndView viewArticle(@RequestParam("articleNO") int articleNO, HttpServletRequest request, HttpServletResponse response) throws Exception{
		String viewName = (String)request.getAttribute("viewName");
		Map articleMap = pboardService.viewArticle(articleNO);
		ModelAndView mav = new ModelAndView(viewName);
		mav.addObject("articleMap",articleMap);
		return mav;
	}
	
	@RequestMapping(value="/pboard/*Form.do", method = {RequestMethod.GET,RequestMethod.POST})
	...
	@RequestMapping(value="/pboard/modArticle.do", method = RequestMethod.POST)
	@ResponseBody
	public ResponseEntity modArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse response) throws Exception{
		...
		try {
			pboardService.modArticle(articleMap);
	...
	@Override
	@RequestMapping(value="/pboard/removeArticle.do",method=RequestMethod.POST)
	@ResponseBody
	public ResponseEntity removeArticle(@RequestParam("articleNO") int articleNO, @RequestParam("id") String id, HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		try {
			...
			pboardService.removeArticle(articleNO);
			File destDir = new File(ARTICLE_IMAGE_REPO+"\\"+articleNO);
			FileUtils.deleteDirectory(destDir);
			message = "<script>"
					+ "location.href='"+request.getContextPath()+"/pboard/listArticles.do';"
							+ "</script>";
			resEnt = new ResponseEntity(message,responseHeaders,HttpStatus.OK);
		}catch(Exception e) {
			message = "<script>"
	...
	//코멘트 추가
	@Override
	@RequestMapping(value="/pboard/addNewComment", method=RequestMethod.POST)
	@ResponseBody
	public ResponseEntity addNewComment(HttpServletRequest request, HttpServletResponse response) {
		...
		commentMap.put("id", id);
			try {
				pboardService.addComment(commentMap);
